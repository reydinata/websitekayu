    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        ...
        <nav class="breadcrumbs">
          <ol>
            <li><a href="/">Home</a></li>
            <li class="current"><a href="/allproduct">Product</a></li>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
             <div class="portfolio-details-slider swiper init-swiper">
                 <div class="swiper-wrapper align-items-center">
                  ...
                  <img src="{{ asset('images/products/'.$kayuDetail->foto_kayu)}}" alt="">
                </div>
                 </div>
             </div>
            {{-- <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              ...
              <ul>
                <li><strong>Name</strong>: {{$kayuDetail->nama_kayu}}</li>
                <li><strong>Stock</strong>: {{$kayuDetail->jumlah_kayu}}</li>
                <li><strong>Price</strong>: {{$kayuDetail->harga_kayu}}</li>
              </ul>
            </div>
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
              <h2>Description product {{$kayuDetail->nama_kayu}} wood</h2>
              <p>
                {{$kayuDetail->deskripsi}}.
              </p>
            </div>
    @auth('pelanggans')
    <a href="#modalEdit" data-bs-toggle="modal" class="btn btn-success mt-3"
                onclick="getInputForm({{$kayuDetail->id}})">Buy Now!</a>
@elseif(Auth::guard('admin')->check())

@else
    <div class="mt-3">
        <a href="/login" class="btn btn-secondary">Login for Buying</a>
    </div>
@endauth
