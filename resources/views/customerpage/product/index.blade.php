...
{{--
  ...
  <div class="portfolio-content h-100">
                ...
                <div class="portfolio-info">
                 ...
                 <p>{{  \Illuminate\Support\Str::words($k->deskripsi, 12, '...') }}</p>
                  <a href="{{ asset('images/products/'.$k->foto_kayu)}}" title="{{$k->nama_kayu}}" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                  <a href="{{ URL::to("detailproduct/{$k->id}") }}" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div>
